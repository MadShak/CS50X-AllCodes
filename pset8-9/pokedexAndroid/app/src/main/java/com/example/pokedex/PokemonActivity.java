...
public class PokemonActivity extends AppCompatActivity {
    ...
    private void loadImage(JSONObject response) {
        try {
            ...
            Log.e("Pokedex", "Image JSON error");
        }
    }
    ...
    private void loadDescription(JSONObject response) {
        ...
        try {
            ...
            Log.e("Pokedex", "Description JSON error");
        }
        Log.d("Pokedex", "Species URL: " + speciesUrl);
            ...
            JsonObjectRequest descriptionResponse = new JsonObjectRequest(Request.Method.GET, speciesUrl,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        Log.e("Pokedex", "Text array JSON error");
                    }
                    for (int i = 0; i < descriptions.length(); i++) {
                        try {
                            ...
                            Log.e("Pokedex", "Text string JSON error");
                        }
                    }
                }
                ...
                @Override
                public void onErrorResponse(VolleyError error) {
                    Log.e("Pokedex", "Description request error");
                }
            }
            );
