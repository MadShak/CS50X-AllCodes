...
function Map:init()
    ...
    while x < self.mapWidth do
        ...
        -- creating flag pole n pyramid
        while x == self.mapWidth / 2 + 8 do
            ...
            for y = self.mapHeight / 2 - 4, self.mapHeight do
                self:setTile(x, y, TILE_BRICK)
            end

            x = x + 3

            self:setTile(x + 1, self.mapHeight / 2 - 3, MYFAVORITE_FLAG)
...
function Map:render()
    ...
    if gameState == 'done' then
        ...
        love.graphics.clear(000/000, 000/000, 000/000)
