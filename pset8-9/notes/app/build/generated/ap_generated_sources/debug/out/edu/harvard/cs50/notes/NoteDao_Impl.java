...
public final class NoteDao_Impl implements NoteDao {
  ...
  public NoteDao_Impl(RoomDatabase __db) {
    ...
    this.__preparedStmtOfCreate = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "INSERT INTO notes (title, content) VALUES ('New note', '')";
        return _query;
      }
    };
    this.__preparedStmtOfSave = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "INSERT INTO notes (id, title, content) VALUES (?, ?, ?)";
        return _query;
      }
    };
  ...
  @Override
  public void save(final int id, final String title, final String content) {
    __db.assertNotSuspendingTransaction();
  ...
  @Override
  public void update(final String title, final String content, final int id) {
    __db.assertNotSuspendingTransaction();
